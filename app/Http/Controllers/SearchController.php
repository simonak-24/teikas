...
class SearchController extends Controller
{
    ...
    public function preview(Request $request)
    {
        ...
        $paginator = $this->sortService->highlight($paginator, 'legends', $fragment, $request);
        ...
        $collectors = $this->sortService->highlight($collectors, 'collectors', $fragment, $request);
        ...
        $narrators = $this->sortService->highlight($narrators, 'narrators', $fragment, $request);

        $places = Place::orderBy('name');
        $places = $this->sortService->global($places, 'places', $fragment);
        $places = $places->paginate($preview_count);
        $places = $this->sortService->highlight($places, 'places', $fragment, $request);
        ...
        $sources = $this->sortService->highlight($sources, 'sources', $fragment, $request);
